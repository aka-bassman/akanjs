...
export const baseDictionary = serviceDictionary(["en", "ko"])
  ...
  .translate({
    ...
    cameraPromptHeader: ["Choose a photo", "사진을 선택해주세요"],
    cameraPromptPhoto: ["Choose from library", "앨범에서 선택하기"],
    cameraPromptPicture: ["Take a photo", "사진 찍기"],
    cameraPromptCancel: ["Cancel", "취소"],
    success: ["Success", "성공"],
    failed: ["Failed", "실패"],
