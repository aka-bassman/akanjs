...
Display name used for the native app. Defaults to the Akan app name.

Native package identifier, such as com.example.app. Defaults to com.<appName>.app.

User-facing app version. Defaults to 0.0.1.
