    ...
    <Scroll>
      <Scroll.Slide id="icecream-business" title={l.trans({ en: "Icecream business", ko: "아이스크림 비즈니스" })}>
        ...
        <Docs.Description>
          ...
          <div>
            {l.trans({
              en: `Now, you can run the koyo service locally with the following command. Then, you can access the service at http://localhost:4201.`,
              ko: `이제, koyo 서비스를 로컬 환경에서 다음과 같이 실행할 수 있으며, 브라우저에서 http://localhost:4201 로 접속하면 됩니다.`,
            })}
          </div>
          ...
          <div className="my-4 space-y-3">
            <div className="rounded-lg bg-blue-50 p-3">
              <div className="mb-2 flex items-center gap-2">
                ...
                <strong className="text-blue-800">modelName</strong>
              </div>
            ...
            <div className="rounded-lg bg-green-50 p-3">
              <div className="mb-2 flex items-center gap-2">
                <span className="text-green-600">📝</span>
                <strong className="text-green-800">modelDesc</strong>
              </div>
      ...
      render={({ icecreamOrderInitInPublic, icecreamOrderForm }) => {
        return (
          <div className="space-y-4">
            ...
            <IcecreamOrder.Zone.Card className="space-y-2" init={icecreamOrderInitInPublic} sliceName="icecreamOrderInPublic" />
          </div>
        );
      }}
    />
          ...
          <div className="my-4 space-y-3">
            <div className="rounded-lg bg-purple-50 p-3">
              <div className="mb-2 flex items-center gap-2">
                <span className="text-purple-600">🏷️</span>
                <strong className="text-purple-800">{`l("icecreamOrder.modelName")`}</strong>
              </div>
            ...
            <div className="rounded-lg bg-blue-50 p-3">
              <div className="mb-2 flex items-center gap-2">
                <span className="text-blue-600">➕</span>
                <strong className="text-blue-800">Model.New Button</strong>
              </div>
              <div className="text-blue-700 text-sm">
                {l.trans({
            ...
            <div className="rounded-lg bg-green-50 p-3">
              <div className="mb-2 flex items-center gap-2">
                <span className="text-green-600">📋</span>
                <strong className="text-green-800">Zone.Card</strong>
              </div>
              <div className="text-green-700 text-sm">
                {l.trans({
          ...
          <div>
            {l.trans({
              en: `Now visit http://localhost:4201/icecreamOrder to see your ice cream ordering system!`,
              ko: `이제 http://localhost:4201/icecreamOrder를 방문하면 아이스크림 주문 시스템을 볼 수 있습니다.`,
            })}
          </div>
        </Docs.Description>
      </Scroll.Slide>
