...
export default page().render(() => (
  <Scroll>
    <Scroll.Slide id="css-overview" title={"CSS Styling Guidelines"}>
      ...
      <Docs.Description>
        Comprehensive styling guidelines for Akan.js components using TailwindCSS and akanjs/ui semantic tokens ensuring
        consistency, maintainability and proper theming across applications.
      </Docs.Description>
    </Scroll.Slide>
