  ...
  const menuMap = [
    {
      ...
      subMenus: [
        ...
        { name: l.trans({ en: "Primitive", ko: "Primitive" }), href: "/references/cli/primitive" },
        { name: l.trans({ en: "Workflow", ko: "Workflow" }), href: "/references/cli/workflow" },
        { name: l.trans({ en: "Quality", ko: "Quality" }), href: "/references/cli/quality" },
        { name: l.trans({ en: "Cloud", ko: "Cloud" }), href: "/references/cli/cloud" },
        { name: l.trans({ en: "Tunnel", ko: "Tunnel" }), href: "/references/cli/tunnel" },
        { name: l.trans({ en: "Context", ko: "Context" }), href: "/references/cli/context" },
        { name: l.trans({ en: "Agent", ko: "Agent" }), href: "/references/cli/agent" },
        { name: l.trans({ en: "Code Agent", ko: "Code Agent" }), href: "/references/cli/code" },
    ...
    },
    {
      ...
      subMenus: [
        ...
        { name: l.trans({ en: "Agent", ko: "Agent" }), href: "/references/ui/agent" },
