      ...
      <Scroll.Slide id="overview" title={l.trans({ en: "Mutating", ko: "변경" })}>
        ...
        <Docs.Description>
          ...
          <DocsList>
            ...
            <li>
              {l.trans({
                en: "Query updates (`updateOne`, `updateMany`, `removeMany`, `bulkWrite`) compile to a single atomic SQL statement and do not load documents.",
                ko: "Query update(`updateOne`, `updateMany`, `removeMany`, `bulkWrite`)는 하나의 원자적 SQL 문으로 컴파일되며 document를 로드하지 않습니다.",
              })}
            </li>
            <li>
              {l.trans({
        ...
        <Docs.Alert type="warning">
          <div className="space-y-2">
            ...
            <DocsList>
              <li>
                {l.trans({
                  en: "`updateOne`, `updateMany`, `removeMany`, and `bulkWrite` write directly in the database and do not fire save/update/remove hooks.",
                  ko: "`updateOne`, `updateMany`, `removeMany`, `bulkWrite`는 데이터베이스에 직접 쓰며 save/update/remove hook을 발화하지 않습니다.",
                })}
              </li>
              <li>
                {l.trans({
